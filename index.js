...
io.on('connection', (socket) => {
    ...
    socket.on('instructions-player', instructions => {
        console.log(instructions);
        socket.broadcast.emit('player-positon', instructions);
    })
});
...
expressApp.get('/finalscore', (request, response) => {
    let message = {content: " Players final score"};
