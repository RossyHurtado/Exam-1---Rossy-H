...
function mouseReleased() {
    ...
    if (!buttonReleased(leftButton) && !buttonReleased(rightButton)) {
        ...
        /* In this case we have to create a message that says if the
        player not tap at any button the ball has to stop in the center
...
socket.on('display-controller', instructions => {
